...
HD_PWD='D:/Users/Desktop/FPGA/tinyriscv_cpu/cpu_prj/vivado_prj/cpu_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_SOC_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_SOC_TOP.tcl -notrace
